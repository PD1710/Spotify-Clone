...
const Player = () => {
const {seekBar,seekBg,play,pause,PlayStatus,time,track,previous,next,seekSong}= useContext(PlayerContext)
  ...
  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className='hidden lg:flex items-center gap-2 opacity-75'>
        <img className='w-4' src={assets.play_icon} alts=""/>
        <img className='w-4' src={assets.mic_icon} alts=""/>
        <img className='w-4' src={assets.queue_icon} alts=""/>
        <img className='w-4' src={assets.speaker_icon} alts=""/>
        <img className='w-4' src={assets.volume_icon} alts=""/>
       <div className='w-20 bg-slate-50 h-1 rounded'>
        
       </div>
        <img className='w-4' src={assets.mini_player_icon} alts=""/>
        <img className='w-4' src={assets.zoom_icon} alts=""/>
